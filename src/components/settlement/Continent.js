...
export default function GenerateContinent(props) {
  ...
  function handleAddNation(e) {
    ...
    setGens((prevGens) => {
      return [
        ...prevGens,
        <GenerateNation key={`${key}_${genKey}`} props={currGen} />,
      ];
    });
  }
  ...
  function handleAddSettlement(e) {
    ...
    setGens((prevGens) => {
      return [
        ...prevGens,
        <GenerateSettlement key={`${key}_${genKey}`} props={currGen} />,
      ];
    });
  }
  ...
  function handleAddShop(e) {
    ...
    setGens((prevGens) => {
      return [
        ...prevGens,
        <GenerateShop key={`${key}_${genKey}`} props={currGen} />,
      ];
    });
  }
  ...
  function handleAddTavern(e) {
    ...
    setGens((prevGens) => {
      return [
        ...prevGens,
        <GenerateTavern key={`${key}_${genKey}`} props={currGen} />,
      ];
    });
  }
  ...
  function handleAddNPC(e) {
    ...
    setGens((prevGens) => {
      return [
        ...prevGens,
        <GenerateNPC key={`${key}_${genKey}`} props={currGen} />,
      ];
    });
  }
  ...
  const handleName = () => {
    setName(
      settlementData[NAME1].roll[
      randomNumber(settlementData[NAME1].roll.length)
      ] +
      settlementData[NAME2].roll[
      randomNumber(settlementData[NAME2].roll.length)
      ]
    );
  };
  ...
  const handleSize = () => {
    setSize(
      settlementData[SIZE].roll[randomNumber(settlementData[SIZE].roll.length)]
    );
  };

  const handleLocation = () => {
    setLocation(
      settlementData[LOCATION].roll[
      randomNumber(settlementData[LOCATION].roll.length)
      ]
    );
  };
  ...
  const handleClimates = () => {
    setClimates(
      settlementData[CLIMATES].roll[
      randomNumber(settlementData[CLIMATES].roll.length)
      ]
    );
  };
  ...
  const handleUnique = () => {
    ...
    if (num === 0) {
      setUnique(
        "It is the only place to find the rare mineral " +
        settlementData[MINERAL].roll[
        randomNumber(settlementData[MINERAL].roll.length)
        ]
      );
    } else if (num === 1) {
      setUnique(
        settlementData[CATACLYSM].roll[
        randomNumber(settlementData[CATACLYSM].roll.length)
        ]
      );
    } else if (num === 2) {
      setUnique(
        "It is dominated by " +
        settlementData[LAND_TYPE].roll[
        randomNumber(settlementData[LAND_TYPE].roll.length)
        ]
      );
    } else {
  ...
  const handleDiscovery = () => {
    setDiscovery(
      settlementData[DISCOVERY].roll[
      randomNumber(settlementData[DISCOVERY].roll.length)
      ]
    );
  };
  ...
  const handleDiscoverer = () => {
    setDiscoverer(
      settlementData[DISCOVERER].roll[
      randomNumber(settlementData[DISCOVERER].roll.length)
      ]
    );
  };
  ...
  const handleDCreatures = () => {
    setDCreatures(
      settlementData[D_CREATURES].roll[
      randomNumber(settlementData[D_CREATURES].roll.length)
      ]
    );
  };
  ...
  const handleICreatures = () => {
    setICreatures(
      settlementData[I_CREATURES].roll[
      randomNumber(settlementData[I_CREATURES].roll.length)
      ]
    );
  };
  ...
  const handleDPlants = () => {
    setDPlants(
      settlementData[D_PLANTS].roll[
      randomNumber(settlementData[D_PLANTS].roll.length)
      ]
    );
  };
  ...
  const handleIPlants = () => {
    setIPlants(
      settlementData[I_PLANTS].roll[
      randomNumber(settlementData[I_PLANTS].roll.length)
      ]
    );
  };
        ...
        <div className="flex-auto">
          <div className="p-inputgroup">
            <Button
              className="p-inputgroup-addon"
              icon="pi pi-refresh"
              onClick={handleClimates}
            />
            <span className="p-float-label">
              <InputText
                id="climates"
                value={climates}
                onChange={(e) => setClimates(e.target.value)}
              />
        ...
        <div className="flex-auto">
          <div className="p-inputgroup">
            <Button
              className="p-inputgroup-addon"
              icon="pi pi-refresh"
              onClick={handleDCreatures}
            />
            <span className="p-float-label">
              <InputText
                id="dCreatures"
                value={dCreatures}
                onChange={(e) => setDCreatures(e.target.value)}
              />
        ...
        <div className="flex-auto">
          <div className="p-inputgroup">
            <Button
              className="p-inputgroup-addon"
              icon="pi pi-refresh"
              onClick={handleICreatures}
            />
            <span className="p-float-label">
              <InputText
                id="iCreatures"
                value={iCreatures}
                onChange={(e) => setICreatures(e.target.value)}
              />
        ...
        <div className="flex-auto">
          <div className="p-inputgroup">
            <Button
              className="p-inputgroup-addon"
              icon="pi pi-refresh"
              onClick={handleDPlants}
            />
            <span className="p-float-label">
              <InputText
                id="dPlants"
                value={dPlants}
                onChange={(e) => setDPlants(e.target.value)}
              />
        ...
        <div className="flex-auto">
          <div className="p-inputgroup">
            <Button
              className="p-inputgroup-addon"
              icon="pi pi-refresh"
              onClick={handleIPlants}
            />
            <span className="p-float-label">
              <InputText
                id="iPlants"
                value={iPlants}
                onChange={(e) => setIPlants(e.target.value)}
              />
